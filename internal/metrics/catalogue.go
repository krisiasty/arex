...
var metricDefs = []metricDef{
	...
	{"arista_cpu_irq_percent", "gauge", "CPU time servicing hardware interrupts", lSwitch},
	{"arista_cpu_nice_percent", "gauge", "CPU time on niced processes", lSwitch},
	{"arista_cpu_softirq_percent", "gauge", "CPU time servicing software interrupts", lSwitch},
